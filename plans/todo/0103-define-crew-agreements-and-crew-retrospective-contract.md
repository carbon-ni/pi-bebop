...
## Acceptance criteria
- [ ] `UL.md` defines Crew Agreement, Current Crew Agreements, Agreement proposal, Agreement revision, Agreement activation, Trial Agreement, Crew Retrospective, and Retrospective facilitator.
...
- [ ] `Accepted`, Response, Role, Origin, Crew Broadcast, and Member request retain current canonical meanings; Role and Origin never grant activation authority.
