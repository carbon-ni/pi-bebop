...
- [ ] Tests first cover missing/empty store, first append, exact replay, conflicting replay, concurrent writers, restart, corruption, quarantine, retention, full capacity, unsafe paths/symlinks, both supported Crew layouts, and injected failures.
