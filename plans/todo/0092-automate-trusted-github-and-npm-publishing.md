...
priority: high
tags: [release, github-actions, npm, oidc, provenance, security]
---
...
- [ ] npm publication uses trusted publishing/OIDC, public access, and provenance. Workflow permissions are minimal and no long-lived npm token is stored or consumed.
...
## Constraints
Remote trusted-publisher and protected-environment configuration is an authorized operator step and must be documented rather than guessed by automation.
