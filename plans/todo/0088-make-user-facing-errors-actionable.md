...
- Extension lifecycle baseline slice: `46bc41a` changes only `src/extension.ts` `pi-notify` allowance 3→2; frozen source/tests remain unchanged and a disposable third-notify render fails the guard.
- Crew roles CLI slice: `b9b1311`/`7650d6b`/`c67d266`/`08c87b0` migrate missing/ambiguous descriptors, enforce safe project-relative location, and prove real runner format/full parity with empty stderr; exactly its count-2 allowance was removed.
- Root CLI usage slice: `855e6cd` migrates both parse/UsageError adapters to a closed actionable usage descriptor and removes exactly its count-2 allowance, preserving format and exit2 behavior.
- Startup-send reporter slice: `9047cf2` adds a typed UI/headless presenter-once adapter, delegates only the error branch, and removes exactly its count-1 allowance; info/warn and RPC/flag/success/turn behavior remain unchanged.
- Session-start reporter slice: `9775567` delegates the private error reporter to the accepted typed adapter and removes exactly its count-2 allowance; startup/reconcile/restore/cleanup behavior remains unchanged.
- Extension lifecycle delegation slice: `5928193` widens the typed adapter to nullable context, delegates the fixed lifecycle descriptor, and removes exactly the extension count-2 allowance; lifecycle callers/cleanup/no-turn behavior remain unchanged.
- Canonical CLI presenter guard slice: `9fefc38` adds a narrow exact-file exclusion for the shared `src/cli/errors.ts` presenter and removes exactly its count-2 allowance; consumer detection remains enforced.
- Source-session guard slice: `620fd2c` adds only an exact-file exclusion for the non-rendering resolver and removes exactly its count-4 allowance; copied consumer renders remain guarded.
- Member-idle-wait CLI slice: `d1c6014` extracts transport/mappers to infra, migrates the public usage/error renders to closed actionable descriptors, and removes exactly its count-11 allowance while preserving runtime/tool/domain semantics.
- Exact-hash QA: startup/lifecycle PASS at `b5b84fb` (focused `36/36`, watcher gen282, full `1,460/1,460`); Crew Init PASS at `9bc871f` (focused `62/62`, watcher gen294, full `1,461/1,461`); Send PASS at `9f3f6e0` (watcher gen307, full `1,463/1,463`); get_member_status PASS at `399273a` (guard 13, watcher gen310); send_to_inbox PASS at `681e4d6` (guard 13, watcher gen314); interrupt_member PASS at `ab88bcf` (guard 13, watcher gen318); Member Request PASS at `68909bc` (guard 13, watcher gen322); Member Intent PASS at `ff595e1` (watcher gen351); Crew Board PASS at `ce1a726` (guard 13, watcher gen354); wait_for_member_idle PASS at `eeb9851` (guard 13, watcher gen378); broadcast_to_crew PASS at `ae0c493` (guard 13, watcher gen382); extension lifecycle PASS at `46bc41a` (guard 13, watcher gen385); crew roles PASS at `08c87b0` (guard 12, watcher gen401); root CLI usage PASS at `855e6cd` (watcher gen414); startup-send reporter PASS at `9047cf2` (guard 10, watcher gen422); session-start PASS at `9775567` (guard 9, watcher gen427); extension lifecycle delegation PASS at `5928193` (guard 8, watcher gen434); canonical CLI presenter guard PASS at `9fefc38` (guard 7, watcher gen438); source-session guard PASS at `620fd2c` (guard 6, watcher gen443); member-idle-wait PASS at `d1c6014` (guard 5, watcher gen455). Reports: `.tmp/reports/13-04-26/task-0088-b5b84fb-final-qa.md`, `.tmp/reports/13-04-26/task-0088-9bc871f-final-qa.md`, `.tmp/reports/13-04-26/task-0088-9f3f6e0-final-qa.md`, `.tmp/reports/13-04-26/task-0088-399273a-final-qa.md`, `.tmp/reports/13-04-26/task-0088-681e4d6-final-qa.md`, `.tmp/reports/13-04-26/task-0088-ab88bcf-final-qa.md`, `.tmp/reports/13-04-26/task-0088-68909bc-final-qa.md`, `.tmp/reports/13-04-26/task-0088-ff595e1-final-qa.md`, `.tmp/reports/13-04-26/task-0088-ce1a726-final-qa.md`, `.tmp/reports/13-04-26/task-0088-eeb9851-member-idle-baseline-qa.md`, `.tmp/reports/13-04-26/task-0088-ae0c493-final-qa.md`, `.tmp/reports/13-04-26/task-0088-46bc41a-final-qa.md`, `.tmp/reports/13-04-26/task-0088-08c87b0-final-qa.md`, `.tmp/reports/13-04-26/task-0088-855e6cd-root-usage-qa.md`, `.tmp/reports/13-04-26/task-0088-9047cf2-startup-send-output-qa.md`, `.tmp/reports/13-04-26/task-0088-9775567-session-start-delegation-qa.md`, `.tmp/reports/13-04-26/task-0088-5928193-extension-lifecycle-delegation-qa.md`, `.tmp/reports/13-04-26/task-0088-9fefc38-cli-presenter-guard-qa.md`, `.tmp/reports/13-04-26/task-0088-620fd2c-source-session-guard-qa.md`, `.tmp/reports/13-04-26/task-0088-d1c6014-member-idle-wait-qa.md`.
