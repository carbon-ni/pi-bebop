...
## Acceptance criteria
- [ ] Post-publication verification resolves the exact expected version from npm and confirms its package identity, distribution tag, provenance, and checksum against the GitHub Release artifact.
