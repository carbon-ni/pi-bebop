...
- [ ] Log append never changes message acceptance, mode, FIFO, retry, response, timeout, cancellation, or cleanup behavior. If evidence append fails, the original outcome remains truthful and one bounded actionable diagnostic/gap signal is retained where possible.
