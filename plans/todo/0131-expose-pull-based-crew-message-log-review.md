...
- [ ] One shared application query authenticates Current Membership at execution and store-read boundaries; every Current Member has identical access and Membership loss during a read rejects deterministically.
...
- [ ] Results use deterministic chronological/lifecycle ordering, stable pagination, exact retained/truncated/gap counts, and bounded entries. Repeated identical reads return byte-equivalent data while retained storage is unchanged.
...
- [ ] The Retrospective adapter selects one exact interval, maps canonical entries to TASK-0112/TASK-0111 evidence with stable references/fingerprints, and reports retention/corruption/unavailable ranges as gaps rather than absence of messaging.
