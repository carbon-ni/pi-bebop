...
| **Crew directory**          | Bounded local view mapping exact Crew Selectors to trusted eligible Crew Locators, availability, and freshness without exposing session or endpoint transport.                                                                                                                                | `bebop session live`, filesystem scan                   |
