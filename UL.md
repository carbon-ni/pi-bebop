...
| **Guest approver**       | Exact manifest-configured Member name listed in `crew.guestApprovers`, allowed to approve, deny, or revoke Guests; no role or online-state fallback is inferred.                                                                                                               | admin, lead, owner, authority                           |
...
- **Guest approver/role:** approver power comes only from exact `crew.guestApprovers` names; lead, product owner, contact, first online, and role labels never grant approval.
