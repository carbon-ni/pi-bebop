...
| **Crew Broadcast**       | Internal transient fan-out initiated by a current joined member; one normal Broadcast Follow-up is attempted for every other configured member, while durable delivery remains explicit through `send_to_inbox`.                                                                 | intake, shared inbox, redirect-all, team broadcast      |
